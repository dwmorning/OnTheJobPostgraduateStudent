...
Page({
    ...
    getSchool: function(t) {
        var a = this;
        wx.request({
            url: getApp().globalData.https + "SchoolData/id/" + a.data.schoollid + "/lx/" + a.data.typeid + "/urlname/" + a.data.majortxt,
            header: {
    ...
    getArticle: function(a) {
        ...
        e.data.catid;
        wx.request({
            url: getApp().globalData.https + "ArticleList/catid/" + e.data.catid + "/school_id/" + e.data.schoollid + "/lx/" + e.data.typeid,
            header: {
                "Content-Type": "application/json"
            },
            method: "GET",
    ...
    getWenda: function(t) {
        var a = this;
        wx.request({
            url: getApp().globalData.https + "WendaList/lx/" + a.data.typeid + "/school_id/" + a.data.schoollid,
            header: {
                "Content-Type": "application/json"
            },
            method: "GET",
    ...
    goSchool: function() {
        wx.navigateTo({
            url: "../../school/showIndex/index?&schoollid=" + this.data.schoollid + "&typeid=" + this.data.typeid
        });
    },
    showCont: function(t) {
    ...
    filter: function(t) {
        a = 2;
        var e = this, o = t.currentTarget.dataset.id, i = t.currentTarget.dataset.txt, s = this.data.tabTxt, d = t.currentTarget.dataset.wayid, n = t.currentTarget.dataset.schoolid, r = t.currentTarget.dataset.majorid, l = t.currentTarget.dataset.areaid, c = t.currentTarget.dataset.areazid;
        switch (t.currentTarget.dataset.index) {
          ...
          case "3":
            "allArea" == t.currentTarget.dataset.area ? (wx.request({
                url: getApp().globalData.https + "SchoolData/id/" + e.data.schoollid + "/lx/" + e.data.typeid + "/urlname/" + e.data.majortxt + "/fs/" + d + "/xy/" + n + "/zy/" + r + "/dd/" + l + "/cs/" + c,
                data: {},
                header: {
                    "Content-Type": "application/json"
                },
    ...
    onReachBottom: function() {
        ...
        e.setData({
            ...
            url: getApp().globalData.https + "SchoolData/page/" + a + "/id/" + e.data.schoollid + "/lx/" + e.data.typeid + "/urlname/" + e.data.majortxt + "/fs/" + e.data.wayid + "/xy/" + e.data.schoolid + "/zy/" + e.data.majorid + "/dd/" + e.data.areaid + "/cs/" + e.data.areazid,
            header: {
                "Content-Type": "application/json"
            },
            method: "GET",
            ...
            url: getApp().globalData.https + "WendaList/page/" + a + "/lx/" + e.data.typeid + "/school_id/" + e.data.schoollid,
            data: {},
            header: {
                "Content-Type": "application/json"
            },
            ...
            url: getApp().globalData.https + "ArticleList/page/" + a + "/catid/" + e.data.catid + "/school_id/" + e.data.schoollid + "/lx/" + e.data.typeid,
            data: {},
            header: {
                "Content-Type": "application/json"
            },
            ...
            success: function(a) {
                for (var o = a.data.data, i = e.data.zixunList, s = 0; s < o.length; s++) {
                    var d = o[s].inputtime;
                    o[s].inputtime = t.formatTime(d, "Y-M-D");
                }
